...
#define ART_BACKGROUND		"menu/art/options"
...
void Options_MenuInit( void ) {
	...
	s_options.graphics.color			= color_menutext;
	...
	s_options.display.color				= color_menutext;
	...
	s_options.sound.color				= color_menutext;
	...
	s_options.network.color				= color_menutext;
