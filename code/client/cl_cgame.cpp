...
// ZOID
	...
	case CG_CM_TEMPBOXMODEL:
		return CM_TempBoxModel( (vec_t*)VMA(1), (vec_t*)VMA(2), /*int capsule*/ qfalse );
	case CG_CM_TEMPCAPSULEMODEL:
		return CM_TempBoxModel( (vec_t*)VMA(1), (vec_t*)VMA(2), /*int capsule*/ qtrue );
	case CG_CM_POINTCONTENTS:
		return CM_PointContents( (vec_t*)VMA(1), args[2] );
	case CG_CM_TRANSFORMEDPOINTCONTENTS:
		return CM_TransformedPointContents( (vec_t*)VMA(1), (clipHandle_t)args[2], (vec_t*)VMA(3), (vec_t*)VMA(4) );
	case CG_CM_BOXTRACE:
		CM_BoxTrace( (trace_t*)VMA(1), (const vec_t*)VMA(2), (const vec_t*)VMA( 3 ), (vec_t*)VMA(4), (vec_t*)VMA(5), (clipHandle_t)args[6], args[7], /*int capsule*/ qfalse );
		return 0;
	case CG_CM_CAPSULETRACE:
		CM_BoxTrace( (trace_t*)VMA(1), (const vec_t*)VMA(2), (const vec_t*)VMA(3), (vec_t*)VMA(4), (vec_t*)VMA(5), (clipHandle_t)args[6], args[7], /*int capsule*/ qtrue );
		return 0;
	case CG_CM_TRANSFORMEDBOXTRACE:
		CM_TransformedBoxTrace( (trace_t*)VMA(1), (const vec_t*)VMA(2), (const vec_t*)VMA(3), (vec_t*)VMA(4), (vec_t*)VMA(5), (clipHandle_t)args[6], args[7], (const vec_t*)VMA(8), (const vec_t*)VMA(9), /*int capsule*/ qfalse );
		return 0;
	case CG_CM_TRANSFORMEDCAPSULETRACE:
		CM_TransformedBoxTrace( (trace_t*)VMA(1), (const vec_t*)VMA(2), (const vec_t*)VMA(3), (vec_t*)VMA(4), (vec_t*)VMA(5), (clipHandle_t)args[6], args[7], (const vec_t*)VMA(8), (const vec_t*)VMA(9), /*int capsule*/ qtrue );
		return 0;
	...
	case CG_S_ADDLOOPINGSOUND:
		S_AddLoopingSound( args[1], (vec_t*)VMA(2), (vec_t*)VMA(3), args[4] );
		return 0;
	case CG_S_ADDREALLOOPINGSOUND:
		S_AddRealLoopingSound( args[1], (vec_t*)VMA(2), (vec_t*)VMA(3), args[4] );
		return 0;
