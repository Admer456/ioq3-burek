...
#ifdef STANDALONE
  #define PRODUCT_NAME				"BurekTech"
  #define BASEGAME					"base"
  #define CLIENT_WINDOW_TITLE		"BurekTech"
  #define CLIENT_WINDOW_MIN_TITLE	"Burek"
  #define HOMEPATH_NAME_UNIX		".burektech"
  #define HOMEPATH_NAME_WIN			"BurekTech"
  #define HOMEPATH_NAME_MACOSX		HOMEPATH_NAME_WIN
//  #define STEAMPATH_NAME			"Foo Bar"
//  #define STEAMPATH_APPID         ""
  #define GAMENAME_FOR_MASTER		"BurekTech"	// must NOT contain whitespace
  #define CINEMATICS_LOGO		"bureklogo.roq"
...
#define	Macro_SnapVector(v) {v[0]=((int)(v[0]));v[1]=((int)(v[1]));v[2]=((int)(v[2]));}
...
#include "surfaceflags.hpp"			// shared with the q3map utility
...
enum ButtonBits
{
	...
	Button_Talk = 1 << 1,
	Button_UseHoldable = 1 << 2,
	Button_Gesture = 1 << 3,

	// walking can't just be inferred from MOVE_RUN because a key pressed late in the frame will only generate
	// a small move value for that frame walking will use different animations and won't generate footsteps
	Button_Walking = 1 << 4,
	Button_Affirmative = 1 << 5,
	Button_Negative = 1 << 6,
	Button_GetFlag = 1 << 7,
...
{
	Interaction_PrimaryAttack = 1 << 0,
	Interaction_SecondaryAttack = 1 << 1,
	Interaction_TertiaryAttack = 1 << 2,
	Interaction_Reload = 1 << 3,
	Interaction_Use = 1 << 4,
	Interaction_UseItem = 1 << 5,

	Interaction_MAX = 1 << 15 // 16 special interaction buttons should be just enough
};
...
typedef struct usercmd_s {
	int				serverTime;
	int				angles[3];
	int 			buttons;			// general-purpose buttons; 32 bits
...
#include "Assets/Models/ModelAnimation.hpp"
#include "Assets/Models/ModelConfigData.hpp"
