...
#ifdef MEQCC
#include "qcc.hpp"
#include "time.hpp"   //time & ctime
#include "math.hpp"   //fabs
#include "l_memory.hpp"
#include "l_script.hpp"
#include "l_precomp.hpp"
#include "l_log.hpp"
...
#include "../bspc/qbsp.hpp"
#include "../bspc/l_log.hpp"
#include "../bspc/l_mem.hpp"
#include "l_precomp.hpp"
	...
	while(!error && firstoperator)
	{
		...
		for (o = firstoperator; o->next; o = o->next)
		{
			...
			if (o->operatorType != P_LOGIC_NOT
					&& o->operatorType != P_BIN_NOT) v = v->next;
		...
		if (integer)
		{
			Log_Write("operator %s, value1 = %d", PunctuationFromNum(source->scriptstack, o->operatorType), v1->intvalue);
			if (v2) Log_Write("value2 = %d", v2->intvalue);
		} //end if
		else
		{
			Log_Write("operator %s, value1 = %f", PunctuationFromNum(source->scriptstack, o->operatorType), v1->floatvalue);
				...
				&& o->operatorType != P_BIN_NOT)
		{
			...
			if (o->operatorType != P_QUESTIONMARK) v = v->next;
			//
			if (v)
			{
